 ...
 *
 */
#include "RecoLocalCalo/EcalRecProducers/plugins/EcalUncalibRecHitWorkerFixedAlphaBetaFitPh2.h"
...
bool EcalUncalibRecHitWorkerFixedAlphaBetaFitPh2::run(const edm::Event& evt,
                                                      const EcalDigiCollectionPh2::const_iterator& itdg,
  ...
  if (pedIter != pedMap.end()) {
    ...
    edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaFitPh2") << "error!! could not find pedestals for channel: ";
    if (detid.subdetId() == EcalBarrel) {
      edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaFitPh2") << EBDetId(detid);
    } else {
      edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaFitPh2") << EEDetId(detid);
    }
    edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaFitPh2") << "\n  no uncalib rechit will be made for this digi!";
    return false;
  }
  double pedVec[3];
  ...
  if (gainIter != gainMap.end()) {
    ...
    edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaFitPh2") << "error!! could not find gain ratios for channel: ";
    if (detid.subdetId() == EcalBarrel) {
      edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaFitPh2") << EBDetId(detid);
    } else {
      edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaFitPh2") << EEDetId(detid);
