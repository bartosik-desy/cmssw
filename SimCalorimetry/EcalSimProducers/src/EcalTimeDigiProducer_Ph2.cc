...
EcalTimeDigiProducer_Ph2::EcalTimeDigiProducer_Ph2( const edm::ParameterSet& params, edm::ProducesCollector producesCollector, edm::ConsumesCollector& sumes) :
   ...
   m_Geometry          ( nullptr ) 
{
   ...
   std::cout << "[EcalTimeDigiProducer_Ph2]::Create EB " << m_EBdigiCollection << " collection and digitizer" << std::endl;
#endif
...
void
EcalTimeDigiProducer_Ph2::initializeEvent(edm::Event const& event, edm::EventSetup const& eventSetup) {
...
void
EcalTimeDigiProducer_Ph2::accumulateCaloHits(HitsHandle const& ebHandle, int bunchCrossing) {
...
void
EcalTimeDigiProducer_Ph2::accumulate(edm::Event const& e, edm::EventSetup const& eventSetup) {
  // Step A: Get Inputs
...
void
EcalTimeDigiProducer_Ph2::accumulate(PileUpEventPrincipal const& e, edm::EventSetup const& eventSetup, edm::StreamID const&) {
  edm::Handle<std::vector<PCaloHit> > ebHandle;
...
void 
EcalTimeDigiProducer_Ph2::finalizeEvent(edm::Event& event, edm::EventSetup const& eventSetup) {
...
void 
EcalTimeDigiProducer_Ph2::checkGeometry( const edm::EventSetup & eventSetup ) 
{
...
void
EcalTimeDigiProducer_Ph2::updateGeometry() 
{
